  ...
  render(){
    ...
    return (
      ...
      <div className="main-container text-center">
        {/* <h1 className="text-center header mb-lg-3">Weather App</h1> */}
             
            
              <input dir="rtl" type="text" className="form-control" placeholder="مثال : تهران " className="search-input mt-4"
              value={search}
